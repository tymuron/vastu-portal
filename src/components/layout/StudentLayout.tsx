            ...
            <header className="bg-vastu-dark text-vastu-light sticky top-0 z-50 shadow-md">
                <div className="container mx-auto px-4 h-16 flex items-center justify-between">
                    <Link to="/student" className="flex items-center gap-3 group">
                        ...
                        <span className="font-serif text-xl tracking-wide text-vastu-gold">ANNA ROMEO</span>
                    </Link>
                    ...
                    <nav className="hidden md:flex items-center gap-8">
                        ...
                        <div className="flex items-center gap-4 pl-8 border-l border-white/10">
                            <div className="flex items-center gap-2">
                                ...
                                <span className="text-sm font-light">Анна Студент</span>
                            </div>
